...
function About() {
  return (
    <div id='about' className='flex flex-col xl:flex-row pt-4 md:pt-16 h-full'>
      <div className='flex flex-col items-center justify-center text-xl md:text-2xl gap-4 p-4 xl:w-2/3'>
      ...
      <div className='flex flex-col items-center justify-center xl:w-1/3 h-full md:mr-4'>
        <div className='flex items-center mt-8 text-white text-3xl md:text-4xl font-bold'>
          <h2>MY STACKS</h2>
        </div>
        <div className='grid grid-cols-3 md:grid-cols-6 xl:grid-cols-4 text-center text-base md:text-xl font-bold text-yellow-500 m-4 mt-0 lg:m-2 lg:w-full h-fit'>
          {skillsData.map((skill, index) => (
            <div key={index}>
              <div>
                <div className='flex items-center justify-center p-8 md:p-6 pb-3 md:pb-2'>
                  <img
                    src={skill.logo}
                    alt={skill.skill}
                    width={150}
